    ...
    body.innerHTML = filtered.map((row) => {
      ...
      return `
        <tr class="attendance-row">
          ...
          <td>Pending</td>
          <td>
            <button class="table-action-btn danger-outline" style="padding: 4px 10px; font-size: 0.78rem;" onclick="alert('Sending warning details for ${row.name}')">
              <i class="fa-solid fa-paper-plane"></i> Notice
            </button>
          </td>
        </tr>
      `;
